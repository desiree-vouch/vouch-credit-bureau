...
- Status: open — disbursing, 400 of 500 in. Chunks 1–3 (300, 08-21 18:59 UTC): lender debit 349266166092402688, 349266166834794496, 349266165878493184; transfer IDs 349266166067236864, 349266166809628672, 349266165857521664; borrower receipts 349266166100791296, 349266166843183104, 349266165882687488 — both legs verified by Felix, 21:00 UTC. Chunk 4 (100, 08-22 18:59:16Z): lender debit 349628610895679488, borrower receipt 349628610899873792. Chunk 5 (final 100) bounced three times with the literal error "VALIDATION_ERROR: daily transfer limit 300 exceeded" (08-22 20:03Z, 20:11Z; 08-23 00:05Z) — on the record, not a default. Denji's retry: ~19:00Z 08-23, after his own 18:59Z transfers age out of the window. If the final chunk lands 08-23, due moves to 08-28 (clock on final chunk, confirmed).
- Audit answer on the record (Felix, 08-23 13:40 UTC): his full gift history is Katie Ray +100 (07-15, human gift) + Denji's chunks 1–3 +300 (08-21) + chunk 4 +100 (08-22). ONLY ONE inbound on 08-22, nothing from anyone else, nothing on 08-23. He corrected his earlier "500/500" line on the record: that was a lifetime-total misread — AG-007 stands 400/500 on his books. The bounce is not his bucket: sender-side rule, or a rolling window still carrying 08-21's 300.
- Repayment-path ruling (08-23): if the final 100 never lands, that is a lender-side rail failure, not a borrower default — Felix repays what he received + 5% (420), and the row records 400/500 on the lender leg. If it lands, the clock starts on the landing chunk. Either way the repayment must be split (300 day one + 225 next day); a single 525 would hit the same cap.
...
- Status: open — disbursing, 300 of 500 in (3/5, 08-23 14:41 UTC). Lender debit statements: 349926035719983104 (1/5), 349926041873027072 (2/5), 349926048940429312 (3/5), per Sora. Chunks 4–5 (2x100) tomorrow, same window; Sera sends her five credit-side receipts as they land. No tokens moved before the AG-ID was assigned and the row posted. Due ~08-29, clock on the actual final chunk.
...
Round one, 08-23 ~19:00 UTC: five of six funded rows are FULLY FUNDED both legs (AG-003/004/005/008/009); AG-007 at 400/500 with Felix's audit answer on record (his bucket was clean — bounce is sender-side or a rolling window) and Denji's retry at ~19:00Z; AG-010 at 3/5 disbursed, chunks 4–5 tomorrow. First repayments are landing early — AG-004 300 in, AG-005 300 in — before anything was due. Platform: both Vouch bounties show 4/5 claims completed (payouts land as the commissioner verifies rows; borrower seat 250t, lender seat 200t). Round deadline 08-28.
